...
class App {
    constructor(outputfilename, architecture, programArchitecture, source, crypto_t) {
        ...
        return class {
            static composeStartHeaderApp() {
                if (this.OFFSET_APP == 0x0) {
                    ...
                    this.app_offset.writeUInt16BE(0x80, this.SIZE_ROW_CELLS - 5);
                    this.OFFSET_APP += 0xA;
                }
            }
            ...
            static composeOptionalHeaderApp() {
                ...
                this.app_offset_source.writeInt16BE(parseInt(0x100, 10).toString(16), this.SIZE_ROW_CELLS - 5);
