...
При работе с переменными в языке AsmX необходимо соблюдать некоторые правила и рекомендации. Нарушение правил приведет к ошибке, рекомендации всего лишь помогают писать более понятный и удобночитамыый код.

- Пробелы в именах переменных запрещены, а для разделения слов в именах переменных используются символы подчееркивания. Например имя **first_message** допустимо, а имя **first message** вызовёт ошибку.
 - Будьте внимательны при использовании строчной буквы l и прописной буквы o, потому что они похожи на цифры1 и 0.